...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String USGS_REQUEST_URL =
            "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=1996-01-01&endtime=2012-12-01&minmagnitude=8&alertlevel=green";
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                Log.e(LOG_TAG,"IO error" + urlConnection.getResponseCode(),e);
            } finally {
